...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_dock(self) -> None:
        ...
        tick_widget, tick_dock = self.create_dock(
            TickMonitor, _("Market Data"), QtCore.Qt.DockWidgetArea.RightDockWidgetArea
        )
        ...
        active_widget, active_dock = self.create_dock(
            ActiveOrderMonitor, _("Active Orders"), QtCore.Qt.DockWidgetArea.RightDockWidgetArea
        )
        trade_widget, trade_dock = self.create_dock(
            TradeMonitor, _("Trade History"), QtCore.Qt.DockWidgetArea.RightDockWidgetArea
        )
